...
function makeSignificanceFormatterUtility($name) {
    return [
        ...
        'examples' => '<div class="text-center"><table><thead><tr><th scope="col" rowspan="2">Input</th><th scope="col" colspan="2">Outputs</th></tr><tr><th scope="col">number</th><th scope="col">prefix</th></tr></thead><tbody><tr><td><tt>/1234/3</tt></td><td><tt>1.23</tt></td><td><tt>k</tt></td></tr><tr><td><tt>/99.7/2</tt></td><td>100</td><td>(nothing)</td></tr></tbody></table></div>',
    ];
}
