...
function makeSignificanceFormatterUtility($name) {
    return [
        ...
        'description' => "This expresses a specified number with a specified number of <a href='https://en.wikipedia.org/wiki/Significant_figures'>significant digits</a> (aka sigfigs), using metric prefixes as necessary.",
