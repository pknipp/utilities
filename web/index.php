...
foreach ($options as $option) {
  $app->get("/axisMaker/{xMin}/{xMax}/{xWidth}/{xLabel}$option", function(string $width, string $xMin, string $xMax, Request $request, Response $response, LoggerInterface $logger, Twig $twig) {
    $data = [
      'xMin' => $xMin,
      'xMax' => $xMax,
      'width' => $width,
